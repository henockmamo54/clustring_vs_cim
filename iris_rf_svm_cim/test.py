...
predprobalist=[rf_ypredprob,svc_ypredprob,xgb_ypredprob]
ypredconfprob_all=[rf_ypredconfprob_all,svc_ypredconfprob_all,xgb_ypredconfprob_all]
...
eclf1 = VotingClassifier(estimators=[
        ('rfclf', rfclf), ('svcclf', svcclf), ('xgbclf', xgbclf) ], voting='soft')
...
eclf2 = VotingClassifier(estimators=[
        ('rfclf', rfclf), ('svcclf', svcclf), ('xgbclf', xgbclf) ], voting='hard')
...
print( m.accuracy_score(rf_ypred,xgb_ypred)) 
print( m.accuracy_score(xgb_ypred,svc_ypred)) 
...
temp["classifer3_XGBoost"] = xgb_ypred
